...
const Button: React.FC<ButtonProps> = ({ text, isCompleted, onClick }) => {
  ...
  let buttonClasses =
    "w-[312px] h-[50px] px-6 py-3 bg-gray rounded-[5px] justify-center items-center gap-2.5 flex";

  // Si el formulario está completo, cambia las clases y el color de fondo
  if (isCompleted) {
    buttonClasses =
      "w-[312px] h-[50px] px-6 py-3 bg-purple hover:bg-purple-hover active:bg-purple-dark rounded-[5px] justify-center items-center gap-2.5 flex";
  }
